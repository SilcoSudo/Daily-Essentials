                    ...
                    <div class="product-detail-right">
                        ...
                        <c:choose>
                            <c:when test="${p.productQuantity == 0}">
                                <p id="quantityProduct"><strong>Status: </strong>Sold Out</p>
                            </c:when>
                            <c:otherwise>
                                <p id="quantityProduct"><strong>Status: </strong>${p.productQuantity} items</p>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <div class="quantity-control">
                            ...
                            <input type="text" value="${sessionScope.productInCart}" id="quantity" />
                            <button class="quantity-btn" id="increment">+</button>
                        </div>

                        <button class="btn-add-to-cart" id="btnAddToCart_details" data-product-id="${p.productId}" <c:if test="${p.productQuantity == 0}">disabled</c:if>>
                                <svg
                                ...
                                <p class="textQuantityProduct">Add to cart</p>
                            </button>
                        </div>
                    </section>
