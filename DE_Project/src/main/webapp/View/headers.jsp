...
<script>
    function resetActiveIndex() {
        localStorage.removeItem('activeSlidebarIndex');
    }
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (activeItemIndex !== null) {
            ...
            slidebarIcons[0].classList.add("active");
            localStorage.setItem("activeSlidebarIndex", 0);
        }
...
<div class="slidebar">
    <div class="w-slidebar">
        ...
        <a class="logout" id="logoutButton" href="${pageContext.request.contextPath}/Authen/Logout"  onclick="resetActiveIndex();"
           ><img
